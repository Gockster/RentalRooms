...
const translations = {
    ...
    gr: {
        ...
        hero: {
            slides: [
                {
                    title: "Κυκλαδίτικα Καταλύματα",
                    subtitle: "Αυθεντική νησιωτική διαβίωση με μοντέρνες ανέσεις"
                },
                {
                    title: "Άνετα Διαμερίσματα",
                    subtitle: "Ιδανικά για μοναχικούς ταξιδιώτες και ψηφιακούς νομάδες"
                },
                {
                    title: "Οικογενειακοί Χώροι",
                    subtitle: "Ευρύχωροι χώροι για παρέες και οικογένειες"
                },
                {
                ...
                {
                    title: "Παραθαλάσσια Καταφύγια Μυκόνου",
                    subtitle: "Γοητευτικά δωμάτια μόλις λίγα βήματα από τα κύματα του Αιγαίου"
                }
            ],
