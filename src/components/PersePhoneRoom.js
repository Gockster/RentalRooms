          ...
          <div className="room-header">
            <div className="room-breadcrumb">
              ...
              <span className="breadcrumb-current">
                {currentLanguage === 'en' ? 'Persephone Room' : 'Δωμάτιο Περσεφόνη'}
              </span>
            </div>
            <div className="room-title-section">
              ...
              <p className="room-subtitle">
                {currentLanguage === 'en' 
                  ? 'Perfect for families seeking comfort and spaciousness.' 
                  : 'Ιδανικό για οικογένειες που αναζητούν άνεση και ευρυχωρία.'}
              </p>
            </div>
          </div>
          <div className="room-content">
            <div className="room-gallery-section">
              <div className="room-main-image">
                <img 
                  src={mainImage}
                  alt={currentLanguage === 'en' ? 'Persephone Room' : 'Δωμάτιο Περσεφόνη'}
                ...
                <div className="room-specs">
                  <div className="spec-item">
                    ...
                    <div className="spec-info">
                      ...
                      <p>{currentLanguage === 'en' ? '1 Queen Size Bed' : '1 Διπλό Κρεβάτι'}</p>
                    </div>
                  </div>
                  <div className="spec-item">
